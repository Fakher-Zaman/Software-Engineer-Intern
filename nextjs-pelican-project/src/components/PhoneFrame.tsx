...
export function PhoneFrame({
  ...
  return (
    <div className={clsx('relative aspect-[366/729]', className)} {...props}>
      ...
      <div className="absolute bg-white left-[calc(23/366*100%)] top-[calc(23/729*100%)] grid h-[calc(686/729*100%)] w-[calc(318/366*100%)] transform grid-cols-1 overflow-hidden bg-gray-900 pt-[calc(23/318*100%)]">
        {children}
      </div>
      <PlaceholderFrame className="pointer-events-none absolute inset-0 h-full w-full fill-white" />
      <Image
        src={frame}
        alt=""
