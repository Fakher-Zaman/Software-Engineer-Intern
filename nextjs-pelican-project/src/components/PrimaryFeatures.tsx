...
const features = [
  {
    ...
    description:
      'Benefit from expert recommendations and investment options curated by financial professionals.',
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
    ...
    description:
      'Access investment recommendations, funding resources, and tax-saving strategies tailored to your specific education goals.',
  ...
  },
  {
    ...
    description:
      'Gain access to a library of educational content to help you navigate your investment journey with confidence.',
  ...
  },
  {
    ...
    description:
      'Receive personalized coaching and support to ensure you’re on track to achieve your goals.',
    icon: DeviceTouchIcon,
    screen: InviteScreen,
  },
]
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          <h2 className="text-3xl font-medium tracking-tight text-white">
            Now is the Time to Secure Your Loved One’s Future
          </h2>
          <p className="mt-2 text-lg text-gray-400">
            Start saving now and pave the way for their success, because the earlier you begin, the brighter their tomorrow.
          </p>
        </div>
      </Container>
